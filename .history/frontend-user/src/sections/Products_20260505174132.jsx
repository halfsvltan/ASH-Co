  ...
  return (
    <section id="products" className="products">
      ...
      <p className="section-desc">
        Jangan galau kalo lo gabisa design kaos kece atau galau karena pengen beli produk ori tapi di pabrikan udah sold out.{" "}
        <span>
          Lo tinggal cek pakaian dengan design yang sesuai sama lo atau pakaian
          yang udah jadi wishlist lo disini!
        </span>
      </p>
...
/* ===== FIX TOTAL WARNA BIRU ===== */

/* Tap highlight (mobile & chrome) */
* {
  -webkit-tap-highlight-color: transparent !important;
}

/* Hilangkan selection biru */
::selection {
