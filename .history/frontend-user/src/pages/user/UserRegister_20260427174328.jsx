  ...
  const handleRegister = async (e) => {
    ...
    try {
      const { error } = await supabase.auth.signUp({
        ...
        options: {
          data: { username },
          emailRedirectTo: `${window.location.origin}/auth/callback`, // ✅ FIX
        },
      });
        ...
        {successMsg && (
          <div className="form-success">
            ...
            <p className="email-info">
              📩 Cek notifikasi email kamu untuk aktivasi akun
            </p>
        ...
        <form className="register-form" onSubmit={handleRegister}>
          ...
          <div className="form-group">
            ...
            <ul className="password-checklist">
              <li className={rules.length ? "ok" : ""}>Minimal 8 karakter</li>
              <li className={rules.upper ? "ok" : ""}>1 huruf besar</li>
              <li className={rules.number ? "ok" : ""}>1 angka</li>
              <li className={rules.symbol ? "ok" : ""}>1 simbol</li>
            </ul>
          </div>
