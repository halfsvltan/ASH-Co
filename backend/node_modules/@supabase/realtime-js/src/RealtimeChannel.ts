...
export default class RealtimeChannel {
  ...
  /** @internal */
  _isMember(topic: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: sc: string): boolean {
  ...
  private static isEqual(obj1: { [key: string]: string }, obj2: { [key: string]: string }) {
    ...
    fo/** @internal */
  _on(type: string, filter: { [key: string]: aneturn false
      }
    }
 ...
 r (const k in obj1) {
      if (obj1[k] !== obj2[k]) {
        r this._on(CHANNEL_EVENTS.error, {}, (reason: string) => callback(reason))
  }
